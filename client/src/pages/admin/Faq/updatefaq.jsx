...
export default function Updatefaq(props) {
   ...
   return <>
    ...
    <Stack component="form"  style={{marginLeft:"15px"}} onSubmit={handleSubmit} className={style.form} marginTop={5} marginLeft={20} style={{backgroundColor:"#0ecfe8"}}>     
        <div >
...
// </Grid>
//   </Grid>
<Grid  item display="flex" justifyContent="center" alignItems="center" xs={12} sm={12} md={12}>  <Button variant="outlined" onClick={(e)=>handleSubmit(e,props.faqdetail._id)}styles={{marginTop:"20px",marginBottom:"30px",width:"300px",display:"flex",flexDirection:"column",justifyContent:"center"}} >Update</Button>
</Grid>
