    ...
    <>
      ...
      > 
        ...
        <p className={style["aboutcontent"]}>
          ...
          IIT Mandi. XPECTO’22 envisioned a platform where our nation’s astute
          ...
          domains. After the astounding participation of 7200+ contestants from
          650+ colleges across India, it is back with another thunderous
          edition. XPECTO’23 now flaunts a plethora of offline events, where the
          contestants will be accommodated in IIT Mandi. XPECTO’23 aspires to be
          the greatest offline convention of the brightest contestants in the
